...
import 'package:medkitapp/state/Patient.dart';
...
class PatientProfile extends StatelessWidget {
  ...
  PatientProfile({this.patientDetails});
            ...
            child: Column(
              children: <Widget>[
                Hero(
                  ...
                  child: CircleAvatar(
                    radius: height * 0.1,
                    backgroundImage: NetworkImage(patientDetails.photoUrl),
                  ),
                ),
                SizedBox(
                  height: height * 0.03,
